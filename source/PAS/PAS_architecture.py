...
def PAS_truncate(processed_rx, source_symbols, original_bits, block_len, NPol,k):
    if(NPol==1):
        ...
        return processed_rx, source_symbols, original_bits, num_blocks
    else:
        processed_rx0, source_symbols0, original_bits0, num_blocks = PAS_truncate(processed_rx[0], source_symbols[0], original_bits[0], block_len, 1, k)
        processed_rx1, source_symbols1, original_bits1, num_blocks = PAS_truncate(processed_rx[1], source_symbols[1], original_bits[1], block_len, 1, k)
