...
def main():
    ...
    Linewidth = 100*10**6 #Linewidth of laser in Hz
    ...
    NFFT = 2**12 #Adjusted to minimise complexity
    NOverlap = 1000 #Given by minimum equaliser length N_CD : pg 113 CDOT graph?
    ...
    print('∆νT:                 ', maxDvT)
    print('Laser Linewidth:     ', Linewidth/1e6,'MHz')
